...
<body>
<header>
    <img src="<?= $plugin_base_url ?>/phile-icon.png" title="PhileCMS" alt="Phile Logo"/>
</header>
<div class="main">
    ...
    <div class="body">
        ...
        <p>
            ...
            triggered in file
            <span class="file">
                <?= $exception_file ?></span> on line <span
                class="line"><?= $exception_line ?>
            </span>.
        </p>
        <?= $exception_fragment ?>
        <?php
        if (isset($exception_backtrace)) : ?>
            <h2>Backtrace</h2>
            <?= $exception_backtrace ?>
            <?php
        endif; ?>
